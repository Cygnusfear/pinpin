import { Point, BoundingBox, Widget, KeyModifiers, SnapTarget } from '../types/canvas';
...
export class DragManager {
  ...
  cancelDrag(): void {
    ...
    this.onDragUpdate?.({ x: 0, y: 0 }, this.dragState.draggedWidgetIds);
  ...
  // Generate snap targets from other widgets
  private generateSnapTargets(widgets: Widget[], excludeIds: string[]): SnapTarget[] {
